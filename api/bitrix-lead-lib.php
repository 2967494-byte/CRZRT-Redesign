...
/** Поле «Выберите Ваш район» (список районов РТ). */
const BITRIX_UF_DISTRICT = 'UF_CRM_1678944249213';

/**
 * Сопоставление названия района / города РТ со значением перечисления в Bitrix24.
 */
function bitrix_map_tatarstan_district_enum(string $district): ?string
{
    $normalized = mb_strtolower(trim($district));
    // Убираем префиксы/суффиксы 'г.', 'г ', 'город', 'район', 'р-н' и лишние пробелы
    $cleaned = preg_replace('/^(г\.|г\b|город\b)\s*/iu', '', $normalized);
    $cleaned = preg_replace('/\s*(район|р-н)\b/iu', '', $cleaned);
    $cleaned = trim(preg_replace('/\s+/', ' ', $cleaned));

    $map = [
        'казань' => '1876',
        'набережные челны' => '1878',
        'агрызский' => '1880',
        'агрыз' => '1880',
        'азнакаевский' => '1882',
        'азнакаево' => '1882',
        ...
        'балтасинский' => '1902',
        'балтаси' => '1902',
        'бугульминский' => '1904', // В Bitrix enum: "Бугульминиский"
        'бугульма' => '1904',
        'буинский' => '1906',
        'буинск' => '1906',
        'верхнеуслонский' => '1908',
        'верхний услон' => '1908',
        'высокогорский' => '1910',
        'высокая гора' => '1910',
        'дрожжановский' => '1912',
        'старое дрожжаное' => '1912',
        'елабужский' => '1914',
        'елабуга' => '1914',
        'заинский' => '1916',
        'заинск' => '1916',
        ...
        'зеленодольск' => '1918',
        'кайбицкий' => '1920',
        'большие кайбицы' => '1920',
        'камско-устьинский' => '1922',
        'камское устье' => '1922',
        'кукморский' => '1924',
        'кукмор' => '1924',
        'лаишевский' => '1926',
...
function bitrix_build_enroll_lead_fields(array $input): array
{
    ...
    if ($district !== '') {
        $fields['ADDRESS_REGION'] = $district;
        $districtEnum = bitrix_map_tatarstan_district_enum($district);
        if ($districtEnum !== null) {
            $fields[BITRIX_UF_DISTRICT] = $districtEnum;
        }
    }
    ...
    if ($district !== '' && strpos($baseComments, 'Район:') === false) {
        $commentParts[] = 'Район: ' . $district;
    }
