      ...
      <div class="hero-editor-grid">
        ...
        <div class="hero-editor-controls-col">
          ...
          <div class="form-group" style="display:flex; gap:10px; align-items:center;">
             ...
             <input type="color" id="consulting_hero_title_color" value="${hero.titleColor || '#000000'}">
          </div>
          <div class="form-group" style="display:flex; gap:10px;">
             <div style="flex:1;"><label>Отступ заголовка сверху (px):</label><input type="number" class="form-control" id="consulting_hero_title_top" value="${hero.titleTop !== undefined ? hero.titleTop : 122}"></div>
             <div style="flex:1;"><label>Отступ заголовка слева (px):</label><input type="number" class="form-control" id="consulting_hero_title_left" value="${hero.titleLeft !== undefined ? hero.titleLeft : 70}"></div>
          </div>
          ...
          <div class="form-group" style="display:flex; gap:10px; align-items:center;">
             ...
             <input type="color" id="consulting_hero_subtitle_color" value="${hero.subtitleColor || '#333333'}">
          </div>
          <div class="form-group" style="display:flex; gap:10px;">
             <div style="flex:1;"><label>Отступ подзаголовка сверху (px):</label><input type="number" class="form-control" id="consulting_hero_subtitle_top" value="${hero.subtitleTop !== undefined ? hero.subtitleTop : 213}"></div>
             <div style="flex:1;"><label>Отступ подзаголовка слева (px):</label><input type="number" class="form-control" id="consulting_hero_subtitle_left" value="${hero.subtitleLeft !== undefined ? hero.subtitleLeft : 70}"></div>
          </div>
        </div>
      </div>`;
