...
(function () {
  ...
  function renderCurrentQuestion() {
    ...
    if (!q) return;
    if (qProgressLabel) qProgressLabel.textContent = "Вопрос ".concat(currentQuestionIndex + 1, " \u0420\u0451\u0420\xB7 ").concat(questions.length);
  ...
  function finishQuiz() {
    ...
    var timeSpentStr = spentMin > 0 ? "".concat(spentMin, " мин. ").concat(spentSec, " \u0421\u0403\u0420\xB5\u0420\u0454.") : "".concat(spentSec, " \u0421\u0403\u0420\xB5\u0420\u0454.");
