...
(function () {
  ...
  function renderHeroAdmin(data) {
      ...
      <div class="obuchenie-hero-grid">
        ...
        <div class="obuchenie-hero-fields-col" style="display:flex; flex-direction:column; gap:20px;">
          ...
          <div class="obuchenie-hero-block" style="border: 1px solid var(--card-border); padding: 15px; border-radius: 8px; background: rgba(255,255,255,0.02);">
            ${blockHeaderWithColorHtml('Заголовок (Enter — перенос строки)', 'ecp_hero_title_color', hero.titleColor, '#ffffff', hero.titleFontSize, hero.titleFontWeight, hero.titleItalic, hero.titleUnderline)}
          ...
          <!-- Block "Текст" -->
          <div class="obuchenie-hero-block" style="border: 1px solid var(--card-border); padding: 15px; border-radius: 8px; background: rgba(255,255,255,0.02);">
            ${blockHeaderWithColorHtml('Текст', 'ecp_hero_subtitle_color', hero.subtitleColor, '#ffffff', hero.subtitleFontSize, hero.subtitleFontWeight, hero.subtitleItalic, hero.subtitleUnderline)}
            <div class="form-group" style="margin-bottom:0; margin-top:8px;">
    ...
    ['title', 'subtitle'].forEach(field => {
        ...
        const size = document.getElementById(`ecp_hero_${field}_size`);
        const weight = document.getElementById(`ecp_hero_${field}_weight`);
        const italic = document.getElementById(`ecp_hero_${field}_italic`);
        const underline = document.getElementById(`ecp_hero_${field}_underline`);
  ...
  function collectEcpPageFromForm(existing) {
    ...
    data.hero = {
      ...
      titleFontSize: document.getElementById('ecp_hero_title_size')?.value || '',
      titleFontWeight: document.getElementById('ecp_hero_title_weight')?.value || '',
      titleItalic: document.getElementById('ecp_hero_title_italic')?.checked || false,
      titleUnderline: document.getElementById('ecp_hero_title_underline')?.checked || false,
      ...
      subtitleFontSize: document.getElementById('ecp_hero_subtitle_size')?.value || '',
      subtitleFontWeight: document.getElementById('ecp_hero_subtitle_weight')?.value || '',
      subtitleItalic: document.getElementById('ecp_hero_subtitle_italic')?.checked || false,
      subtitleUnderline: document.getElementById('ecp_hero_subtitle_underline')?.checked || false
    };
